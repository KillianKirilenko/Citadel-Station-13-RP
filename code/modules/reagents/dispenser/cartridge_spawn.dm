/client/proc/spawn_chemdisp_cartridge(size in list("small", "medium", "large"), reagent in GLOB.wSSchemistry.chemical_reagents)
	...
	var/datum/reagent/R = GLOB.SSchemistry.chemical_reagents[reagent]
	C.setLabel(R.name)
